...
EQUIPMENT_CONTRACT = AgentContract(
    ...
    tools=("get_machine_status", "get_fault_information", "check_replacement_part", "create_maintenance_request", "investigate_equipment_fault"),
...
INVENTORY_CONTRACT = AgentContract(
    ...
    tools=("get_inventory_status", "get_material_inventory", "get_finished_goods", "calculate_max_production", "check_supply_thresholds", "calculate_defect_rate", "calculate_weight_variance", "record_defect"),
...
ORCHESTRATOR_CONTRACT = AgentContract(
    ...
    tools=("Equipment Agent as tool", "Production Agent as tool", "Inventory Agent as tool", "calculate_system_impact", "detect_state_conflicts", "request_human_approval", "record_decision"),
